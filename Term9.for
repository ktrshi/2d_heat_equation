     ...
     2          F (nn,mm), Xn(nn,mm), XX(nn)   , YY(mm) 
      DIMENSION AL0(NN,MM), AL5(NN,MM), AL6(NN,MM), AL7(NN,MM), 
     1          AL8(NN,MM),
...
50    continue
!
!      CALL ALT(A0, A5, A6, A7, A8, AL0, AL5, AL6, AL7, AL8, ALOK, N2,M2)
!
      nstep = 0
      time  = 0.0D0
200   continue
...
!------------------------------------------------------------
      ...
      call SOLVE (A0,A5,A6,A7,A8,AL0,AL5,AL6,AL7,AL8,F,PP,R,Xn,
     2              FIL,EPSH,YC,N2,M2)
      do i=1,N2
          do j=1,M2
              X(i,j) = Xn(i,j)
